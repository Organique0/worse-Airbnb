...
const LoginModal = () => {
    ...
    const footerContent = (
        <div className="flex flex-col gap-4">
            <hr />
            <Button outline label="continue with Google(not working)" icon={FcGoogle} onClick={() => signIn('google')} />
            <Button outline label="continue with Github(not working)" icon={AiFillGithub} onClick={() => signIn('github')} />
