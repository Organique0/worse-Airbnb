...
const RentModal = () => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = (data) => {
        ...
        axios.post('/api/listings', data)
            .then(() => {
                ...
                toast.error("something did not go as planed")
            });
    }
    ...
    if (step == STEPS.IMAGES) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="Add a photo for your place" subtitle="Show your guest what your home looks like!" />
    ...
    if (step == STEPS.DESCRIPTION) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="How would you describe your place?" subtitle="Short and simple" />
